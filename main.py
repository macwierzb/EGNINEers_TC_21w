...
if __name__ == "__main__":
    ...
    image_diff.save_image(os.path.join(project_dir, "result"), ImageFormat.JPG)  # save in JPG
    image_diff.save_image(os.path.join(project_dir, "result"), ImageFormat.PNG)  # save in PNG
